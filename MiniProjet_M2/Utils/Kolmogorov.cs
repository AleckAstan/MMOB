...
public class Kolmogorov
{
    ...
    // Calculer la probabilité de transition de i à j en n étapes
    ...
    // Vérifier la probabilité de transition en utilisant Chapman-Kolmogorov
